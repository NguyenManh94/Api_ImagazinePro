using ApiImagazine.Models;
using ApiImagazine.Models.ExtendModel;
using System;
...
namespace ApiImagazine.Controllers
{
    public class PostContentController : ApiController
    {
        private MagazineProgramingEntities _db = new MagazineProgramingEntities();
        /// <summary>
